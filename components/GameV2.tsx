...
export default function GameV2({
  ...
  return (
    <main className="relative flex flex-col items-center justify-start md:justify-center min-h-[100svh] md:min-h-[calc(100svh-8rem)] px-4 pt-20 md:pt-6 pb-6 overflow-x-hidden overflow-y-auto">
