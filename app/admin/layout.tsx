...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col bg-[color:var(--color-navy)] text-white">
      <header className="fixed top-0 left-0 right-0 z-50 flex flex-col border-b border-[color:var(--color-border)] bg-[color:var(--color-navy)]">
      ...
      <div className="flex-1 pt-24 pb-10">{children}</div>
    </div>
  );
}
